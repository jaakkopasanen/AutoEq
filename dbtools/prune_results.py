...
target_to_source = {
    ...
    'Headphone.com Legacy/earbud': ROOT_PATH.joinpath('measurements', 'Headphone.com Legacy', 'data', 'earbud'),
    'Headphone.com Legacy/in-ear': ROOT_PATH.joinpath('measurements', 'Headphone.com Legacy', 'data', 'in-ear'),
    'Headphone.com Legacy/over-ear': ROOT_PATH.joinpath('measurements', 'Headphone.com Legacy', 'data', 'over-ear'),
