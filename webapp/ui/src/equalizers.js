export default [
  { label: '10-band Graphic Eq', type: 'fixedBand', config: '10_BAND_GRAPHIC_EQ', uiConfig: { showFsControl: false } },
  { label: '31-band Graphic Eq', type: 'fixedBand', config: '31_BAND_GRAPHIC_EQ', uiConfig: { showFsControl: false } },
  {
    label: 'AUNBandEq', type: 'parametric', config: 'AUNBANDEQ',
    uiConfig: {
      bw: true, showDownload: false, showFsControl: true,
