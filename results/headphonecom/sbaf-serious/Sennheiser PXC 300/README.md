...
`Sennheiser PXC 300 GraphicEQ.txt` to `C:\Program Files\EqualizerAPO\config\HeSuVi\eq\custom\` folder.

### Peace
In case of using Peace, click *Import* in Peace GUI and select `Sennheiser PXC 300 ParametricEQ.txt`.
...
| Peaking | 1423 Hz  | 1.5  | -3.6 dB |
| Peaking | 2345 Hz  | 4.51 | -2.4 dB |
| Peaking | 9837 Hz  | 3.24 | -8.7 dB |
| Peaking | 58 Hz    | 4.21 | 0.7 dB  |
| Peaking | 4862 Hz  | 5    | -6.7 dB |
| Peaking | 4896 Hz  | 1.85 | 4.2 dB  |
| Peaking | 6974 Hz  | 5.7  | -4.2 dB |
| Peaking | 12012 Hz | 6.3  | 2.1 dB  |
...
![](https://raw.githubusercontent.com/jaakkopasanen/AutoEq/master/results/headphonecom/sbaf-serious/Sennheiser%20PXC%20300/Sennheiser%20PXC%20300.png)