...
`Massdrop x Fostex TH-X00 Ebony GraphicEQ.txt` to `C:\Program Files\EqualizerAPO\config\HeSuVi\eq\custom\` folder.

### Peace
In case of using Peace, click *Import* in Peace GUI and select `Massdrop x Fostex TH-X00 Ebony ParametricEQ.txt`.
...
| Type    | Fc      |    Q | Gain    |
|:--------|:--------|:-----|:--------|
| Peaking | 17 Hz   | 1.15 | 5.1 dB  |
| Peaking | 66 Hz   | 1.73 | 1.5 dB  |
| Peaking | 2213 Hz | 0.4  | -2.1 dB |
| Peaking | 4286 Hz | 1.8  | 8.5 dB  |
| Peaking | 5650 Hz | 2.94 | -6.0 dB |
| Peaking | 24 Hz   | 1.49 | -0.7 dB |
| Peaking | 447 Hz  | 0.98 | 3.4 dB  |
| Peaking | 650 Hz  | 0.45 | -3.1 dB |
| Peaking | 1490 Hz | 0.78 | 2.0 dB  |
| Peaking | 2422 Hz | 5.36 | -1.4 dB |
