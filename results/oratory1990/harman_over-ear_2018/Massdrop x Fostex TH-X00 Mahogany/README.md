...
`Massdrop x Fostex TH-X00 Mahogany GraphicEQ.txt` to `C:\Program Files\EqualizerAPO\config\HeSuVi\eq\custom\` folder.

### Peace
In case of using Peace, click *Import* in Peace GUI and select `Massdrop x Fostex TH-X00 Mahogany ParametricEQ.txt`.
...
| Type    | Fc       |    Q | Gain    |
|:--------|:---------|:-----|:--------|
| Peaking | 21 Hz    | 2.89 | 4.4 dB  |
| Peaking | 1659 Hz  | 0.7  | -4.4 dB |
| Peaking | 3977 Hz  | 1.52 | 8.8 dB  |
| Peaking | 7163 Hz  | 2.57 | -6.5 dB |
| Peaking | 13688 Hz | 4.29 | -6.9 dB |
| Peaking | 421 Hz   | 1.91 | 2.6 dB  |
| Peaking | 779 Hz   | 3.93 | -2.7 dB |
| Peaking | 5916 Hz  | 6.63 | -3.9 dB |
| Peaking | 7636 Hz  | 1.66 | 3.7 dB  |
| Peaking | 7797 Hz  | 5.74 | -5.6 dB |
...
![](https://raw.githubusercontent.com/jaakkopasanen/AutoEq/master/results/oratory1990/harman_over-ear_2018/Massdrop%20x%20Fostex%20TH-X00%20Mahogany/Massdrop%20x%20Fostex%20TH-X00%20Mahogany.png)