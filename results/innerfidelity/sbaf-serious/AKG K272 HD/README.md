...
### Peace
In case of using Peace, click *Import* in Peace GUI and select `AKG K272 HD ParametricEQ.txt`.
...
| Peaking | 84 Hz   | 4.52 | -1.7 dB  |
| Peaking | 108 Hz  | 5.7  | 5.3 dB   |
| Peaking | 320 Hz  | 0.58 | -1.8 dB  |
| Peaking | 644 Hz  | 3.31 | -4.3 dB  |
| Peaking | 724 Hz  | 2.24 | 3.3 dB   |

![](https://raw.githubusercontent.com/jaakkopasanen/AutoEq/master/results/innerfidelity/sbaf-serious/AKG%20K272%20HD/AKG%20K272%20HD.png)